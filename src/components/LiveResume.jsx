export default function LiveResume({
  ...
  return (
    <div className="render-resume" ref={contentRef}>
      <div className="live-resume" id="preset1">
        <div className="personal-details">
          <h1 className="name">{resumeData.personalDetails.name}</h1>
          <p className="email">{resumeData.personalDetails.email}</p>
          <p className="mobile">{resumeData.personalDetails.mobile}</p>
        ...
        {showProfile && (
          <div className="profile-container">
            ...
            <p className="profile">{resumeData.personalDetails.profile}</p>
          </div>
        )}
        {showEducation && (
        ...
        {showExperience && (
          <div className="experience">
            ...
            <hr />
            <div className="comp1">
              <p className="post">{resumeData.experience.comp1.post}</p>
              <p className="company">{resumeData.experience.comp1.company}</p>
              <p className="location">{resumeData.experience.comp1.location}</p>
              ...
              <p className="details">{resumeData.experience.comp1.details}</p>
            </div>
            {resumeData.experience.comp2.activationStatus === 1 && (
              <div className="comp2">
                <p className="post">{resumeData.experience.comp2.post}</p>
                <p className="company">{resumeData.experience.comp2.company}</p>
                ...
                <p className="endDate">{resumeData.experience.comp2.endDate}</p>
                <p className="details">{resumeData.experience.comp2.details}</p>
              </div>
            )}
            {resumeData.experience.comp3.activationStatus === 1 && (
              <div className="comp3">
                <p className="post">{resumeData.experience.comp3.post}</p>
                <p className="company">{resumeData.experience.comp3.company}</p>
                <p className="location">
                ...
                <p className="details">{resumeData.experience.comp3.details}</p>
              </div>
            )}
          </div>
        )}
        {showProjects && (
          <div className="projects">
            ...
            <div className="project1">
              <p className="name">{resumeData.projects.project1.name}</p>
              <p className="details">{resumeData.projects.project1.details}</p>
            </div>
            {resumeData.projects.project2.activationStatus === 1 && (
              <div className="project2">
                <p className="name">{resumeData.projects.project2.name}</p>
                <p className="details">
            ...
            {resumeData.projects.project3.activationStatus === 1 && (
              <div className="project3">
                <p className="name">{resumeData.projects.project3.name}</p>
                <p className="details">
