...
import Projects from "../web/editor/Projects";
  ...
  return (
    <div className="enter-details">
      ...
      <div className="enter-details-content">
        <h2 className="group-heading" id="personal-details">
          Personal Details
        </h2>
        <PersonalDetails
          ...
          resume={resume}
        />
        <h2 className="group-heading" id="education-details">
          Education Details
        </h2>
        <EducationDetails
          resumeData={resumeData}
        ...
        <h2 className="group-heading" id="projects">
          Projects
        </h2>
