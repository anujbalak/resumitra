      ...
      <div className="right-sidebar">
        ...
        <div className="right-sidebar-content">
          ...
          <div className="presets">
            <Preset img={preset1Img} id="preset1" clickHandler={clickHandler} />
            <Preset img={preset2Img} id="preset2" clickHandler={clickHandler} />
            <Preset img={preset3Img} id="preset3" clickHandler={clickHandler} />
            {/* <Preset
                            img={preset1Img}
                            id='preset4'
          ...
          <h3 className="hide-show-label">Hide/Show Fields</h3>
          <div className="hide-show">
            <Checkbox
              label="Profile"
              checkEventHandler={() =>
                toggleField(showProfile, setShowProfile, "profile-container")
              }
              checked={showProfile}
            />
            <Checkbox
            ...
            <Checkbox
              label="Experience"
              checkEventHandler={() =>
                toggleField(showExperience, setShowExperience, "experience")
              }
            ...
            <Checkbox
              label="Projects"
              checkEventHandler={() =>
                toggleField(showProjects, setShowProjects, "projects")
              }
              checked={showProjects}
            />
          </div>
          <div className="print-container">
            <Button name="Print" btnEventHandler={handlePrint} />
          </div>
        </div>
      </div>
    </>
