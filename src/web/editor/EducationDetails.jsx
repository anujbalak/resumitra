...
export default function EducationDetails({ resumeData, setResumeData }) {
  ...
  return (
    <div className="education-details-container" id="education-container">
      <>
        <Institute1 setResumeData={setResumeData} resumeData={resumeData} />
        {activatedInstitute[1] === 1 && (
          <>
            <hr />
            <Institute2 setResumeData={setResumeData} resumeData={resumeData} />
          </>
        )}
        {activatedInstitute[2] === 1 && (
          <>
            <hr />
            <Institute3 setResumeData={setResumeData} resumeData={resumeData} />
          </>
        )}
