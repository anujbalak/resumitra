...
export default function Experience({ resumeData, setResumeData }) {
  ...
  return (
    <div className="experience-container">
      <>
        <Comp1 setResumeData={setResumeData} resumeData={resumeData} />
        {activatedComps[1] === 1 && (
          <>
            <hr />
            <Comp2 setResumeData={setResumeData} resumeData={resumeData} />
          </>
        )}
        {activatedComps[2] === 1 && (
          <>
            <hr />
            <Comp3 setResumeData={setResumeData} resumeData={resumeData} />
          </>
        )}
        {activatedComps.some((code) => code === 0) && (
          <Button name="Another Institute" btnEventHandler={addFieldHandler} />
        )}
      </>
    </div>
  );
